...
const DoctorCard = ({ item }) => {
  ...
  return (
    <div key={item.id} className="col-span-1 rounded-lg  p-0">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
        <img
          className="rounded-lg md:h-[300px]"
          src={item.photo}
          alt={item.name}
        />
        ...
        <div className="p-5">
          ...
          <p className="text-sm font-medium text-[#364153]">  {item.availability}</p>
          <div className="flex items-center flex-wrap gap-3 mt-5 justify-between">
